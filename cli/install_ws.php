...
/**
 * CLI install webservice for digital training account services
 *
 * Notes:
...
if ($options['help']) {
    $help =
            "install compelte webservice (service, role, user and user assignment) for digital training account services
...
$result = local_digital_training_account_services_tools::install_webservice_completely();
$trace->finished();
